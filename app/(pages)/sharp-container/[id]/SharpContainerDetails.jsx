...
const SharpContainerDetails = ({ productId }) => {
            ...
            <div className="grid grid-cols-1 sm:flex sm:flex-wrap gap-3 sm:gap-4">
             ...
             href="https://wa.me/+918810422935"
              ...
              <button
                ...
                className="w-full sm:w-auto text-center bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition"
              >
                Enquire Now
              </button>
            </div>
...
export default SharpContainerDetails;
